...
@Injectable()
export class PacsIndexerProcessor extends WorkerHost {
  ...
  constructor(
    ...
    if (!accessKeyId || !secretAccessKey) {
        throw new Error('S3 credentials (S3_ACCESS_KEY, S3_SECRET_KEY) are required for PacsIndexerProcessor.');
    }
